...
age_dist = read_excel("data/clean/sweden/age_structure.xlsx") %>%
...
sweden_data_28march = read.csv("data/clean/sweden/selected_swedish_cases_20200328_1036.csv") %>%
  tbl_df() %>%
...
# and entered the row:
#  80,488,65,
age_distributions_cases_deaths_28march = read.csv("data/clean/sweden/age_distributions_cases_deaths_28march.csv") %>%
  tbl_df()
